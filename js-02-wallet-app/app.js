...
const harcamayiDomaYaz = ({id, miktar, tarih, alan}) => {
    ...
    // 2. yontem
    const tr = document.createElement("tr") // tr elementi olusturur
    // tr elementinin ilk 3 td sini olusturur
    const appendTd = (content) => {
        const td = document.createElement("td")
        td.textContent = content
        return td
    }
    // tr elementinin son td sini olusturur
    const createLastTd = () => {
        const td = document.createElement("td")
...
harcamaBody.addEventListener("click", (e) => {
    ...
    // silinen harcamayı arrayden cıkarır
...
temizleBtn.addEventListener("click", () => {
    if (confirm("silmek istediğinize emni misiniz?")) {
